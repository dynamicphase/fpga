...
if not os.path.isfile(filename):
    ...
    if len(topfile.input_ports) != len(topfile.input_pins):
        ...
        wrapper = (verilog_wrapper(filename_base+'_wrapper.v', topfile.module_name,
                    topfile.input_ports, topfile.output_ports, topfile.inout_ports,
                    topfile.input_pins, topfile.output_pins, topfile.inout_pins))
